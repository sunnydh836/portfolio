  ...
  const educationData = [
    {
      year: "2023-2027",
      title: "B.Tech CSE",
      place: "Bharat Institute of Technology, Meerut",
      color: "bg-purple-100",
      details: (
    ...
    },
    {
      ...
      place: "R.S.M.S.V.M Madhav Kunj Meerut UP",
      color: "bg-blue-100",
      details: "CBSE Board | Percentage: 87.4%"
    },
    {
      year: "X",
      title: "Secondary Education",
      place: "L.T.R Public School Kurali Meerut UP",
      color: "bg-green-100",
      details: "CBSE Board | Percentage: 84.4%"
    }
  ];
